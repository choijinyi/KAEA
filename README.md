...
> 참가자(`/bingo/play`)는 게임 코드로 입장해 정답이 될 것 같은 이름 25개를 적고,
> 진행자(`/bingo/host`)는 정답 보드에 100·200·300·500점짜리 이름을 3개씩(총 12개) 적습니다.
> 정답과 일치한 참가자의 이름은 Supabase Realtime(+폴링 백업)으로 자동으로 줄이 그어지고
> 점수가 합산되며, 진행자 화면에는 실시간 순위표가 표시됩니다.
